...
import { ArrowRight, Heart, Wine } from "lucide-react";
        ...
        <div className="space-y-4">
          {matchProfiles.map((profile, i) => (
            <motion.div
              ...
              className="bg-[#1A1A1A] border border-[#333] rounded-2xl p-4 flex items-center gap-4"
            >
              <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#D4AF37]/40 flex-shrink-0">
                <img
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-white font-bold text-lg">{profile.first_name}</h3>
                <p className="text-white/40 text-sm">{profile.age} שנים</p>
              </div>
              <Button
                onClick={() => handleSendDrink(profile)}
                size="sm"
                className="bg-gradient-to-r from-[#B8941F] to-[#D4AF37] text-[#0F0F0F] font-semibold rounded-xl flex-shrink-0"
              >
